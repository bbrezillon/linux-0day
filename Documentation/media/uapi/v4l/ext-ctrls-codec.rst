...
.. flat-table::
    ...
    * - ``V4L2_H264_DPB_ENTRY_FLAG_FIELD``
      - 0x00000008
      - The DPB entry is a field reference. When not set the DPB entry is a
        picture reference
    * - ``V4L2_H264_DPB_ENTRY_FLAG_BOTTOM_FIELD``
      - 0x00000010
      - The DPB entry is a bottom field reference. Only valid if
...
.. flat-table:: enum v4l2_vp9_reset_frame_context
    ...
    * - ``V4L2_VP9_RESET_FRAME_CTX_NONE``
      - Don't reset any frame context.
    * - ``V4L2_VP9_RESET_FRAME_CTX_NONE_ALT``
      - Don't reset any frame context. This is an alternative value for
        V4L2_VP9_RESET_FRAME_CTX_NONE.
